                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2 text-lg">
                            ...
                            <li><Link to="/pathways" className="slate-900 hover:text-[#de9642] transition-colors flex items-center"><ChevronRight className="w-4 h-4 mr-2 slate-900" />Discover Pathways</Link></li>
                            <li><Link to="/student-life" className="slate-900 hover:text-[#de9642] transition-colors flex items-center"><ChevronRight className="w-4 h-4 mr-2 slate-900" />Discover Student Life</Link></li>
                            <li><Link to="/student-life" className="slate-900 hover:text-[#de9642] transition-colors flex items-center"><ChevronRight className="w-4 h-4 mr-2 slate-900" />Discover Talents</Link></li>
                            ...
                            <li><Link to="/fees" className="slate-900 hover:text-[#de9642] transition-colors flex items-center"><ChevronRight className="w-4 h-4 mr-2 slate-900" />Discover Friendly Fees</Link></li>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2 text-lg">
                            ...
                            rel="noopener noreferrer" className="slate-900 hover:text-[#de9642] transition-colors flex items-center"><ChevronRight className="w-4 h-4 mr-2 slate-900" />Pioneer Girls Junior Academy</a></li>
                ...
                <div className="mt-12 pt-8">
                    <div className="text-center">
                        ...
                        <div className="text-gray-900 text-sm">
                            <a href="#" className="hover:text-[#de9642] mr-4">Privacy Policy</a>
                            <a href="#" className="hover:text-[#de9642] mr-4">Disclaimer</a>
                            <a href="#" className="hover:text-[#de9642] mr-4">Sitemap</a>
