...
const JoinGrade8: React.FC = () => {
  

  return (
    <div className="bg-[#e6e7e9ff] font-sans">
      ...
      <section className="py-12 px-4 sm:px-8 max-w-7xl mx-auto">
        <h2 className="text-4xl font-bold text-[#2A2C2E] mb-8">
         ELIGIBILTY REQUIREMENTS FOR JOINING GRADE 8  <br />
        ...
        <div className="space-y-4 text-gray-800 text-lg">
          ...
          <p>5. The student must Provide a recent <strong>report form for Grade 7</strong>. (Original must be submitted; a copy will be kept.)</p>
