    ...
    <section className="bg-[#f8efe1ff] text-start px-4 py-8">
      ...
      <div className="flex flex-wrap justify-center">
        <div className="w-full px-4 py-4">
          ...
          <div className="mt-4 h-1 w-24 bg-blue-700"></div>
        </div>
      </div>
      ...
      <div className="">
        <div className="w-full shadow-lg overflow-hidden">
          ...
          <div className="p-6 space-y-4 text-lg text-gray-800">
            ...
            <div className="mt-4 h-px w-24 bg-yellow-700"></div>
            <p>
          ...
          <div className="p-6 space-y-4 text-lg text-gray-800">
            ...
            <div className="pt-4 flex justify-center">
              <Link
                ...
                className=" px-6 py-3 text-white font-bold text-lg md:text-xl bg-yellow-800 hover:bg-orange-700 transition rounded-md text-center"
              >
